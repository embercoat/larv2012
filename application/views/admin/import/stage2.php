...
<thead>
	<tr>
		...
		<th style="width: 50px;">Utbildningstyp</th>
...
<tbody>
	...
	?>
		...
		<tr <?=(($alternator++ % 2 == 0) ? 'style="background-color: silver;"': ''); ?> >
			...
			<td><?=Form::checkbox('isProgram[]', $key, (($key >= 125 && $key <= 164) ? true : false));?></td>
			<td><?=Form::checkbox('isEducationType[]', $key, (($key >= 165 && $key <= 168) ? true : false));?></td>
			<td><?=Form::checkbox('offers[]', $key, (($key >= 110 && $key <= 119) ? true : false));?></td>
			<td><?=Form::checkbox('ignore[]', $key,  ((($key >= 0 && $key <= 5) || ($key >= 181 && $key <= 184))? true : false));?></td>
		</tr>
	<?php
	}
	?>
