<html>
	...
	<div id="template-cont">
		<h2>Innehållsförteckning: </h2>
			<ul class="press">
				...
				<li><?php echo $c['catalogue_company_name']; ?></li>
				<?php } ?>
			</ul>
	...
	<div id="wrapper-cont">
			...
			<table class="press">
			<tr>
               <th class="foretagab"> <h1><?php echo $c['catalogue_company_name']; ?></h1></th>
			   <th class="right kont">
			   <?php if($c['catalogue_contact_same'] == 'Nej, no') { ?>
                <ul>
                    ...
                    <?php if(!empty($c['catalogue_contact_cell'])) { ?><li><?php echo $c['catalogue_contact_cell']; ?></li><?php  } ?>
                </ul>
                <?php } else { ?>
                <ul>
                    ...
                    <?php if(!empty($c['contact_cell'])) { ?><li><?php echo $c['contact_cell']; ?></li><?php } ?>
                </ul>
                <?php } ?>
				</th>
			</tr>
			...
			<table class="fakta">
                    ...
                    <tr>
                        ...
                        <td class="info">
							...
							<?php if(!empty($c['branches'])){foreach($c['branches'] as $b){ ?>
															<li><a href="#"><?php echo $b['branch']; ?></a></li>
							<?php }}else {?>
                        ...
                        <td class="info">
                            <ul>
								<?php if(!empty($c['cities'])){foreach($c['cities'] as $ci){ ?>
																<li><a href="#"><?php echo $ci['name']; ?></a></li>
								<?php } }else {?>
							...
							<?php
								if(!empty($c['countries'])){
									foreach($c['countries'] as $cy){ ?>
															<li><a href="#"><?php echo $cy['name']; ?></a></li>
							<?php }
								} else {?>
                    ...
                    <tr>
                        ...
                        <td class="info">
                            <ul>
                                <li><a href="#"><?php echo $c['catalogue_employees_sweden']; ?></a></li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="info">
                            <ul>
                                <li><a href="#"><?php echo $c['catalogue_employees_global']; ?></a></li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="info">
							...
							<?php if(!empty($c['programs'])){foreach($c['programs'] as $p) { ?>
															<li><a href="#"><?php echo $p['shortname']; ?></a></li>
							<?php } }else {?>
                    ...
                    <tr>
                        ...
                        <td class="info">
							...
							<?php if(!empty($c['educationtypes'])){foreach($c['educationtypes'] as $e) { ?>
															<li><a href="#"><?php echo $e['shortname']; ?></a></li>
							<?php } }else {?>
	    ...
	    echo ($c['booth'] ? 'images/booth/'.$c['booth']['place'].'.jpg' : 'images/katalog/monterplatskommer.jpg');
				...
				<td class="press mumma">
			        <h2><?php echo ((isset($c['catalogue_company_eng_head']) && $c['catalogue_company_eng_head'] == 1) ? 'About the Company' :'Om Företaget'); ?></h2>
                    <p><?php echo $c['catalogue_company_description']; ?></p>

                    <?php if(!empty($c['catalogue_why_visit'])){ ?>
                    <h2><?php echo ((isset($c['catalogue_company_eng_head']) && $c['catalogue_company_eng_head'] == 1) ? 'Come and talk to us about..' :'Kom och prata med oss om..'); ?></h2>
                    <p><?php echo $c['catalogue_why_visit']; ?></p>
                <?php } ?>
				</td>
            </tr>
